...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("So nguoi lam luan van tot nghiep ngày 22/5/20223: " + soLuongLamLuanVanTotNghiep);

        int soLuongThiTotNghiep = qlhv.demSoLuongThiTotNghiep();
        System.out.println("So nguoi thi tot nghiep ngày 22/5/20223: " + soLuongThiTotNghiep);

        int soLuongThiLai = qlhv.demSoLuongThiLai();
        System.out.println("So nguoi phai thi lai ngày 22/5/20223: " + soLuongThiLai);
